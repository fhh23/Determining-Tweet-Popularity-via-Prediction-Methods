...
#        for a short data run. Streams tweets for 15 minutes using common popular words
#        as keywords. Subsequently searches for each Tweet at 10 minutes, 30 minutes, and
#        60 minutes afterwards and reports on the new number of retweets and favorites.

numIter=10 # Run the data collection program 10 times
counter=0
while [ $counter -lt $numIter ]; do
