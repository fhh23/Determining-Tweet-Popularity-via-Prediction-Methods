...
function my_streaming_callback($data, $length, $metrics) 
{
	...
	if(!is_null($data['text'])) // Only prints the tweet information if $data has valid contents
	{
		...
		if(is_array($entities['urls']))
		{
			...
			*/
			$outputString = "{$outputString}" . empty($entities['urls']); 
		}
		...
		$outputString = "{$outputString}" . "{$data['filter_level']}" . "," . "{$data['id_str']}" . "," . "{$data['in_reply_to_screen_name']}" . "," . "{$data['in_reply_to_status_id_str']}" . "," . "{$data['in_reply_to_user_id_string']}" . "," . "{$place['id']}" . "," . "{$place['place_type']}" . "," . "{$place['full_name']}" . "," . "{$place['country']}" . "," . "{$data['possibly_sensitive']}" . ",";
		...
		$outputString = "{$outputString}" . "{$data['scopes']}" . ",";
